 ...
 */
public class SuccessAnimViewX extends View {
    ...
    public SuccessAnimViewX(Context context) {
        this(context, null);
    }

    public SuccessAnimViewX(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SuccessAnimViewX(Context context, AttributeSet attrs, int defStyleAttr) {
